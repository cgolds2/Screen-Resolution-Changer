    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case Resolution.SetResolution(800, 600)
            Case ResolutionChanger.ChangeResult.Success
                MsgBox("The Resolution was changed to " & CUInt(Screen.PrimaryScreen.Bounds.Height) & " : " & CUInt(Screen.PrimaryScreen.Bounds.Width), MsgBoxStyle.OkOnly)
...
Class ResolutionChanger
    ...
    Partial Public Class User_32
        <System.Runtime.InteropServices.DllImportAttribute("user32.dll", EntryPoint:="EnumDisplaySettingsA")>
        ...
        <System.Runtime.InteropServices.DllImportAttribute("user32.dll", EntryPoint:="ChangeDisplaySettingsA")>
