...
You can find all the necessary files in the Build folder (located in the ScreenResChanger folder), including the exe and a few example profile-running batch files.  You can also compile the program yourself if you so choose.
